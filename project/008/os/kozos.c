...
/* タスク・コントロール・ブロック(TCB) */
/*
 * makeでundefined reference to `___mulsi3' のエラーが発生するので
 * dummy[16](パディング) を追加
 * https://groups.google.com/forum/#!topic/kozos_tomonokai/RCPNP9bpouE
 */
...
/*
 * gcc4.0系では 関数内での関数プロトタイプ宣言はできないので
 * static int setintr()から外に追い出した
 * https://groups.google.com/forum/#!topic/kozos_tomonokai/Lgiu6oIgYuw
 */
