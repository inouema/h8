...
int serial_init(int index)
{
  ...
  //sci->SSR.BYTE = 0;
    ...
    SCI1.SCR.BYTE = H8_3052_SCI_SCR_RE | H8_3052_SCI_SCR_TE; /* 送受信可能 */
...
int serial_is_send_enable(int index)
{
    ...
    return (SCI1.SSR.BYTE & H8_3052_SCI_SSR_TDRE);
...
int serial_send_byte(int index, unsigned char c)
{
    ...
    //PB.DR.BYTE = 0x0A;
    while((SCI1.SSR.BYTE & H8_3052_SCI_SSR_TDRE) == 0);
    //while((sci->SSR.BYTE & H8_3052_SCI_SSR_TDRE) == 0);
...
#endif    
    SCI1.TDR       = c;
    SCI1.SSR.BYTE &= ~H8_3052_SCI_SSR_TDRE; /* 送信開始 */
...
int serial_is_recv_enable(int index)
{
    ...
    return (SCI1.SSR.BYTE & H8_3052_SCI_SSR_RDRF);
...
unsigned char serial_recv_byte(int index)
{
    ...
    /* 受信文字が来るまで待つ */
    while ((SCI1.SSR.BYTE & H8_3052_SCI_SSR_RDRF) == 0);
...
#endif
    c = SCI1.RDR;
    SCI1.SSR.BYTE &= ~H8_3052_SCI_SSR_RDRF; /* 受信完了 */
